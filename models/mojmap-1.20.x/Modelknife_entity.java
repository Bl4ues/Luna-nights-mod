	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition knife = partdefinition.addOrReplaceChild("knife",
				CubeListBuilder.create().texOffs(9, 5)
						.addBox(-0.5F, -0.75F, -0.1667F, 1.0F, 1.5F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
						.addBox(-0.5F, -0.5F, 0.8333F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(7, 2)
						.addBox(0.0F, -0.5F, -6.1667F, 0.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.05F, 16.0F, 0.1667F));
