...
public class Modelknife_entity<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition knife = partdefinition.addOrReplaceChild("knife", CubeListBuilder.create().texOffs(9, 5).addBox(-0.45F, 12.25F, 17.0F, 1.0F, 1.5F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 7)
				.addBox(-0.45F, 12.5F, 18.0F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(7, 2).addBox(0.05F, 12.5F, 11.0F, 0.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 3.0F, -17.0F));
