 ...
 *
 */
package net.mcreator.lunanights;
...
@Mod("luna_nights")
public class LunaNightsMod {
	public static final Logger LOGGER = LogManager.getLogger(LunaNightsMod.class);
	public static final String MODID = "luna_nights";

	public LunaNightsMod() {
