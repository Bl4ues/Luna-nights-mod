...
import net.mcreator.lunanights.block.InvisiBlock2Block;
import net.mcreator.lunanights.block.InvisiBlock1Block;
...
public class LunaNightsModBlocks {
	...
	public static final RegistryObject<Block> INVISI_BLOCK_1 = REGISTRY.register("invisi_block_1", () -> new InvisiBlock1Block());
	public static final RegistryObject<Block> INVISI_BLOCK_2 = REGISTRY.register("invisi_block_2", () -> new InvisiBlock2Block());
