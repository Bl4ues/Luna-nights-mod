...
import net.mcreator.lunanights.item.ShopTicketItem;
...
public class LunaNightsModItems {
	...
	public static final RegistryObject<Item> SHOP_TICKET = REGISTRY.register("shop_ticket", () -> new ShopTicketItem());
	...
	public static final RegistryObject<Item> INVISI_BLOCK_1 = block(LunaNightsModBlocks.INVISI_BLOCK_1);
	public static final RegistryObject<Item> INVISI_BLOCK_2 = block(LunaNightsModBlocks.INVISI_BLOCK_2);
